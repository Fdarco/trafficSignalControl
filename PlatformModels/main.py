...
class traffic_signal_control_strategy(object):
    ...
    def initNetwork(self):
        ...
        for j in range(self.num_j_in):
            ...
            self.junction_in[name_junction].set_now_green_time({1: 19, 2: 19, 3: 20, 4: 20})
...
class HCS(traffic_signal_control_strategy):
...
class DB(traffic_signal_control_strategy):
...
class LQ(traffic_signal_control_strategy):
